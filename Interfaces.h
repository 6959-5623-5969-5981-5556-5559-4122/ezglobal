...
{
    static auto pThis = *reinterpret_cast<DWORD**>(U::pattern_scan(GetModuleHandleW(L"client_panorama.dll"), "B9 ? ? ? ? F3 0F 11 04 24 FF 50 10") + 1);

    static auto find_hud_element = reinterpret_cast<DWORD(__thiscall*)(void*, const char*)>(U::pattern_scan(GetModuleHandleW(L"client_panorama.dll"), "55 8B EC 53 8B 5D 08 56 57 8B F9 33 F6 39"));
